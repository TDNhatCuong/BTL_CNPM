...
if __name__ == "__main__":
    ...
    with app.app_context():
        ...
        u = Patient(name='Truong Dinh Cuong', email='son@gmail.com',
                    password=str(hashlib.md5('123456'.encode('utf-8')).hexdigest()), type="patient", sdt="0123456789", diaChi="Ha Noi", namSinh="1999")
